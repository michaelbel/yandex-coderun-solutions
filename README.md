...
Решения задач с платформы [Yandex CodeRun](https://coderun.yandex.ru) — сервиса для подготовки к техническим собеседованиям и олимпиадам по программированию от Яндекса.

Решения написаны на **Kotlin** и **Java**.

## Подборки авторов

| Подборка | Директория |
|----------|-----------|
| [Решай как олимпиадник](https://coderun.yandex.ru/selections/ababin) — задачи с олимпиад от A. Babina | [ababin/](ababin/readme.md) |
...
| Отбор | Директория |
|-------|-----------|
| [Осенний день стажёра 2023](https://coderun.yandex.ru/selections/autumn-intern-2023) | [autumn-intern-2023/](autumn-intern-2023/readme.md) |
| [Зимний день стажёра 2024](https://coderun.yandex.ru/selections/winter-intern-2024) | [winter-intern-2024/](winter-intern-2024/readme.md) |
